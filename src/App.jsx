                ...
                {selCatalog&&(
                  <div style={{...card,padding:'14px 18px',marginBottom:'16px',display:'flex',gap:'20px',flexWrap:'wrap',alignItems:'center'}}>
                    ...
                    <div style={{display:'flex',gap:'24px',flexWrap:'wrap',alignItems:'center'}}>
                      ...
                      {selCatalog.data_lancamento&&<div><div style={{fontSize:'13px',color:'#664400',marginBottom:'2px'}}>LANÇAMENTO</div><div style={{color:G,fontSize:'18px'}}>{fmtDate(selCatalog.data_lancamento)}</div></div>}
                    </div>
                  </div>
                )}
          ...
          <div>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',marginBottom:'16px'}}>
              {[
                ...
                {l:'DATA DE LANÇAMENTO',v:quickCatalog.data_lancamento?fmtDate(quickCatalog.data_lancamento):'—',c:G},
